...
// 현재 페이지의 메타 정보 가져오기
$current_file = 'pages/notice/logistics-news-detail.php';
...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        FROM news_posts 
        WHERE id = :id AND status = 'published' AND category = 'logistics'
    ");
    ...
    if (!$post) {
        // 게시물이 없으면 목록으로 리다이렉트
        header('Location: ' . BASE_URL . '/pages/notice/logistics-news.php');
        exit;
    }
} catch (Exception $e) {
    // 에러 시 목록으로 리다이렉트
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center">
                    <a href="<?php echo BASE_URL; ?>/pages/notices/logistics-news.php" class="list-button">List</a>
                </div>
            </div>
        </div>
    </section>
