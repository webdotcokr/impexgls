...
// 현재 페이지의 메타 정보 가져오기
$current_file = 'pages/notices/careers.php';
...
// 데이터베이스에서 커리어 게시물 가져오기
try {
    $pdo = getDBConnection();

    // 총 게시물 수 가져오기
    $count_stmt = $pdo->prepare("SELECT COUNT(*) FROM news_posts WHERE status = 'published' AND category = 'careers'");
    $count_stmt->execute();
    ...
    $stmt = $pdo->prepare("
        ...
        FROM news_posts
        WHERE status = 'published' AND category = 'careers'
            ...
            <div class="news-list-table">
                <?php if (!empty($news_items)): ?>
                    ...
                    <div class="news-list-item">
                        ...
                        <a href="<?php echo BASE_URL; ?>/pages/notices/careers-detail.php?id=<?php echo $item['id']; ?>">
